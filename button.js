...
window.DBSDK_Cfg = {
    ...
    export_callback: function (resultUrl, document_id, options) {
		...
		var params = "dbsdk_grabfrom_url=" + resultUrl + "&dbsdk_file_name=" + document_id;
...
(function(doc, win) {
    ...
    DBSDK.startOverlay = function (postId = null) {
    	...
    	if (overlay) {
    		...
    		let overlay = '<div id="DBSDK_notification" class="alert alert-info" role="alert">Please wait a moment for download image !</div>'
    		+ '<div class="db-overlay animated fadeIn" style="display: block;"></div>';
    		doc.body.insertAdjacentHTML('beforeend', overlay);
